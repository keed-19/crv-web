...
const CLIENTSR = () => {
    ...
    useEffect(()=>{
        const loadData = async()=>{            
            ...
            const apiResponse = await api.get('/statusClients/DELETED');
                        ...
                        {/* botones de acciones de la tabla */}
                        {
                            listaAprovados.length !== 0 ?
                                <>
                                    ...
                                    <button class="rounded-full bg-fuchsia-600 px-2 text-white py-1 opacity-25" value='rechazar' disabled>Rechazar</button>
                                    <button class="rounded-full bg-fuchsia-600 px-2 text-white py-1 opacity-25" value='eliminar' disabled>Eliminar</button>
                                </>
                            :
                                <>
